...
public class SimpleLog implements Log{
    ...
    /** Properties loaded from adligo_log.properties */
    static protected Hashtable adligoLogProps = null;
    ...
    private static String getStringProperty(String name) {
        ...
        return (prop == null) ? (String) adligoLogProps.get(name) : prop;
    }
    ...
    static {
        try {
        	adligoLogProps = LoadProperties.loadProperties("/adligo_log.properties", true);
        } catch (IOException x) {
        	x.printStackTrace();
        }
    ...
    public SimpleLog(String name) {
        ...
        String lvl = getStringProperty(logName);
